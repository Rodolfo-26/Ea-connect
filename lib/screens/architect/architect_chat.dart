...
import 'chat_conversacion_screen.dart'; // asegúrate de importar tu pantalla

class ArchitectChatScreen extends StatelessWidget {
  final VoidCallback onToggleTheme;

  const ArchitectChatScreen({super.key, required this.onToggleTheme});
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Sin ubicación', // o data['ubicacion'] si la agregas luego
